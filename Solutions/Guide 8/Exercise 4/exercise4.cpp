...
/* Note that we have the following measurements used with first derivative with an error of O(h²):
    t               I'(t)
    1.000000        -8.513500
    1.100000        -11.184500
    1.200000        -13.682417
    ...
    So, to calculate E(1.2) we have to do:
    1. E(1.2) = I'(1.2) * 0.05 + 2 * I(1.2) = -13.682417 * 0.05 + 2 * 5.9908 = 11.2975 

    2. We use the function I(t) = 10 * exp(-t/10) * sin(2*t) in f(x)
    t               I'(t)
    1.000000        -8.513320
    1.100000        -11.267530
    1.200000        -13.678438
    1.300000        -15.500363
    1.400000        -16.894069
    So, we have E(1.2) = I'(1.2) * 0.05 + 2 * I(1.2) = -13.678438 * 0.05 + 2 * 5.9908 = 11.2977
*/
