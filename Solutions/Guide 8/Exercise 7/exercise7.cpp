...
/**
 * Function to generate data points using the provided X(tita) function
 * and save them to a specified file. 
 * It saves data file with X(tita) and tita in degrees.
 * @param file_name Name of the file to save the generated points
 */
 ...
 * Function to generate data points using the provided X(tita) function
 * and save them to a specified file. 
 * It saves data file with X(tita) and tita in radians.
 * @param file_name Name of the file to save the generated points
 */
void points_generator_rad(const char *file_name);

/**
 * Function to define X(tita) based on trigonometric calculations
 * @param tita Angle in radians
 * @return The value of X at the given angle
 */
double X(double tita);

/* 
This exercise is done in paper. So we only show the results:
theta            f''(x) = acceleration [m/s²]
0.000000        -0.125141
5.000000        -34308.003198
10.000000       -33588.003131
15.000000       -32472.003027
20.000000       -30996.002889
25.000000       -28980.002701
30.000000       -26676.002486
35.000000       -24048.002241
40.000000       -21096.001966
45.000000       -17856.001664
50.000000       -14508.001352
55.000000       -10980.001023
60.000000       -7452.000695
65.000000       -3924.000366
70.000000       -468.000044
75.000000       2736.000255
80.000000       5688.000530
85.000000       8424.000785
90.000000       10728.001000
95.000000       12708.001184
100.000000      14292.001332
105.000000      15480.001443
110.000000      16380.001527
115.000000      16920.001577
120.000000      17208.001604
125.000000      17316.001614
130.000000      17208.001604
135.000000      16992.001584
140.000000      16668.001554
145.000000      16416.001530
150.000000      15984.001490
155.000000      15696.001463
160.000000      15408.001436
165.000000      15120.001409
170.000000      14976.001396
175.000000      14832.001382
180.000000      0.054101
        ...
        switch(number_of_derivative) {
            ...
            case 2:
                if(function_data_table == 1) {
                    ...
                    // Read data points from file
                    if (!read_data_points("measurements_rad.txt", X, Y, &n)) {
                        printf("Failed to read data from file. Exiting.\n");
                        return 1;
                    }
                    // Print the data points
                    ...
                    points_generator_deg("measurements_deg.txt");
                    points_generator_rad("measurements_rad.txt");

                    h = 5 * PI / 180; // 5 degrees in radians, as data is given every 5 degrees
            ...
            case 2:
                if(function_data_table == 1) {
                    ...
                    for(int i = 1; i <= n-2; i++) {
                        ...
                        // }
                        // We have that a = d²x/dt² but a = d²x/d(theta)² * (d(theta)/dt)²
                        // We use (d(theta)/dt)² = w² where w = 523.5988 rad/s 
                        fpp[i] = pow(523.5988, 2) * fpp[i];
                    }
