...
/* 
Doing a minor change in the procedure of Composition Trapeze and then applying it to the problem of the car we have:
    Δt = 1.558881 seconds
*/
    ...
    if (choice == 1) {
        ...
        switch (choice) {
            ...
            case 2: {
                ...
                // Calculate I
                // V = X and P(V) = Y
                // Note that in this exercise we have this condition:
                //  ∫ f(x) dx
                //  ∫ P(V) dV =>  m * ∫(V / P(V)) dV
                //  So we have f(V) = (V / P(V)) to apply on Composition Trapeze
                double F[MAX_POINTS];
                // Mass of the car
                double m = 2000.0;
                ...
                // Dont forget to multiply by mass m
                sum = m * sum;
