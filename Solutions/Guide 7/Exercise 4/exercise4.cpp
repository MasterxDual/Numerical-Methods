...
/**
 * This function is used to calculate the length of a curve (exercise 4)
 * Function g(x) = sqrt(1 + (f'(x))^2)
 * @param x The point at which to evaluate the function (in our case, X̂)
 * @param func Pointer to the function f
 * @return The value of the function g at x
 *  */ 
double g(double x, double (*func)(double));

/** 
 * First derivative using aproximation
 * @param func Pointer to the function
 * @param x The point at which to evaluate the first derivative
 * @param h A small value for the finite difference approximation
 * @return The first derivative of the function at point x
 *  */
double first_derivative(double (*func)(double), double x, double h = 1e-5);
...
/* 
    ...
    Composition Trapeze:
        Subintervals = 5
        The integral is: 1.566845
        Subintervals = 20
        The integral is: 1.549052
        Subintervals = 40
        The integral is: 1.548162
        Subintervals = 80
        The integral is: 1.547940
    --> The trapezoid improves more slowly; to obtain an error similar to Simpson's, it is advisable to increase the trapezoid much more.        
    Composition Simpson:
        Subintervals = 10
        The integral is: 1.547864
        Subintervals = 40
        The integral is: 1.547866
        Subintervals = 80
        The integral is: 1.547866
        Subintervals = 160
        The integral is: 1.547866
    --> Simpson achieves very high accuracy with relatively few subintervals
    --> Mantaining the relation Msimp = 2 * Mtrap is reasonable for comparison

    f(x) = sin(x) 0 <= x <= pi/4 --> a = 0, b = pi/4
    Composition Trapeze:
        Subintervals = 5
        The integral is: 1.057255
        Subintervals = 20
        The integral is: 1.058043
        Subintervals = 40
        The integral is: 1.058082
        Subintervals = 80
        The integral is: 1.058092
    --> The trapezoid improves more slowly; to obtain an error similar to Simpson's, it is advisable to increase the trapezoid much more.  
    Composition Simpson:
        Subintervals = 10
        The integral is: 1.058096
        Subintervals = 40
        The integral is: 1.058096
        Subintervals = 80
        The integral is: 1.058096
    ...
    if (choice == 1) {
        ...
        switch (choice) {
            ...
            case 2: {
                ...
                // Data points to read from text filedouble g(double x, double (*func)(double)) {
...
double g(double x, double (*func)(double)) {
    return sqrt(1 + pow(first_derivative(func, x), 2));
}
