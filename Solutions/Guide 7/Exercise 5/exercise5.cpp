...
/*
Solving the exercise 5 with indeterminant coefficients we reach to a matrix of the form:
        1 1 1
    A = 0 1 2
        0 1 4
...
So we use a data.dat file to insert this matrix and solve it with Gaussian elimination with partial pivoting to find coefficients w0, w1 and w2
    w0 = 0.335
    w1 = 1.33
    w2 = 0.335
