...
/* Doing derivatives in Ecm (Mean Square Error) and using methematical analysis we have the matrix:
| Σxk⁴     Σxk³     Σxk²  | |A|   | Σyk*xk² |
| Σxk³      Σxk²    Σxk¹  | |B| = | Σxk*yk  |
| Σxk²     Σxk¹     N     | |C|   | Σyk     |
So, we have to solve this system to find A, B and C. We can use the gauss elimination method for that. 
Look for this program for more details
