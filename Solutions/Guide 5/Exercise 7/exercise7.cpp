...
/* In this exercise, we need to calculate E = ρ/ε using linear regression. 
    So, we need the shape of the linear equation like ρ = E*ε + b. Notice the units of the variables
    To calculate E and b we use linear regression.
    Notice that we need to calculate the average of ε1, ε2 and ε3
    To do this, we need to sum the values of ε and divide by the number of values.
    average for ρ in 34.5 = ε1 + ε2 + ε3 / 3 = 0.46 + 0.34 + 0.73 / 3 = 0.51 ==> (0.51, 34.5)
    average for ρ in 69.0 = ε1 + ε2 + ε3 / 3 = 0.95 + 1.02 + 1.10 / 3 = 1.023 ==> (1.023, 69.0)
    average for ρ in 103.5 = ε1 + ε2 + ε3 / 3 = 1.48 + 1.51 + 1.62 / 3 = 1.537 ==> (1.537, 103.5)
    average for ρ in 138.0 = ε1 + ε2 + ε3 / 3 = 1.93 + 2.09 + 2.12 / 3 = 2.047 ==> (2.047, 138.0)
So we use this points in data.txt and apply linear regression to find E and b
Results:
    E = 67.317 [MPa/m/mm]
    b = 0.134864 [MPa]
Then: 
    ρ = 67.317*ε + 0.134864
And:
    r = 0.99999 ==> The fit is excellent
*/
