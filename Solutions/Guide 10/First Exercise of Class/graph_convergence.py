...
data1 = np.loadtxt('convergence_midpoint_edo2.txt')
data2 = np.loadtxt('convergence_midpoint2_edo2.txt')
# data3 = np.loadtxt('convergence_Q3.txt')
...
# RK 4 method points
plt.plot(x_convergence1, y_convergence1, 'ro-', label="Euler Method 1", markersize=5)
plt.plot(x_convergence2, y_convergence2, 'bo-', label="Euler Method 2", markersize=5)
# plt.plot(x_convergence3, y_convergence3, 'go-', label="Euler Method 3", markersize=5)

# --- Graph formatting ---
plt.title("Convergence factor (Euler Method)", fontsize=13)
plt.xlabel("x", fontsize=12)
plt.ylabel("Convergence Factor Q1[i] and Q2[i]", fontsize=12)
plt.legend()
plt.grid(True)
