...
data1 = np.loadtxt('convergence_rk4_edo4.txt')
data2 = np.loadtxt('convergence_rk42_edo4.txt')
data3 = np.loadtxt('convergence_rk43_edo4.txt')
data4 = np.loadtxt('convergence_rk44_edo4.txt')
...
plt.plot(x_convergence4, y_convergence4, 'co-', label="RK 4 Method 4", markersize=5)
