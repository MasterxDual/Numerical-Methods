...
data1 = np.loadtxt('convergence_rk4_edo3.txt')
data2 = np.loadtxt('convergence_rk42_edo3.txt')
data3 = np.loadtxt('convergence_rk43_edo3.txt')
...
plt.ylabel("Convergence Factor Q1[i] Q2[i] and Q3[i]", fontsize=12)
plt.legend()
plt.grid(True)

# Axis limits slightly extended
plt.xlim(min(x_convergence1) - 0.5, max(x_convergence1) + 1)
